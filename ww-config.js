  ...
  properties: {
    ...
    members: {
      ...
      options: {
        expandable: false,
        getItemLabel(item) {
          return item.email || item.first_name || item.user_id || 'Member';
        },
        item: {
          type: 'Object',
          defaultValue: {
          ...
          options: {
            item: {
              user_id: { label: { en: 'User ID' }, type: 'Number' },
              first_name: { label: { en: 'First Name' }, type: 'Text' },
              last_name: { label: { en: 'Last Name' }, type: 'Text' },
      ...
      bindingValidation: {
        type: 'array',
        tooltip: 'Bind to TenantMembers collection data. Used to resolve user_id to display name.'
      },
      propertyHelp: 'Bind to your TenantMembers collection data array so user IDs can be resolved to names.',
      /* wwEditor:end */
    },
    pageSize: {
      label: { en: 'Page Size' },
